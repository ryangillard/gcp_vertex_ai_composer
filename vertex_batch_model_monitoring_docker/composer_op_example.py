vertex_batch_model_monitoring_op = (
    kubernetes_pod_operator.KubernetesPodOperator(
        image="gcr.io/my-project/vertex_batch_model_monitoring_image:latest",
        name="vertex_batch_model_monitoring_pod",
        arguments=[
            '--project=my-project',
            '--region=us-central1',
        ...
        namespace="default",
        task_id="vertex_batch_model_monitoring_task",
        dag=test_dag
    )
)